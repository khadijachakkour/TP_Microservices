...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain (HttpSecurity httpSecurity) throws Exception{
        ...
        return httpSecurity
                .sessionManagement(sess-> sess.sessionCreationPolicy(SessionCreationPolicy.STATELESS)) //Session sans état
                .csrf(csrf -> csrf.disable()) //Protection CSRF désactivée
    ...
    //vérifie l’authenticité des tokens JWT
    @Bean
